          ...
          <div class="card">
            ...
            <div class="card-body">
              <div class="tab-content p-0">
                ...
                <form action="/dashboard/admins/{{ $data->id }}" class="form-horizontal" method="post">
                    @method('put')
                    @csrf
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control @error('nama') is-invalid @enderror" placeholder="Nama Lengkap" name="nama" value="{{ old('nama',$user['nama']) }}">
                        @error('nama')
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control @error('alamat') is-invalid @enderror" placeholder="Alamat Lengkap" name="alamat" value="{{ old('alamat',$user['alamat']) }}"">
                            @error('alamat')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control @error('telpon') is-invalid @enderror" placeholder="Masukan Nomor Telepon" name="telpon" value="{{ old('telpon',$user['telpon']) }}"">
                            @error('telpon')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
